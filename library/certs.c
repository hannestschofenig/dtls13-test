...
const char mbedtls_test_ca_crt_ec2[] = TEST_CA_CRT_EC2;
...
const size_t mbedtls_test_cas_len[] = {
	...
	sizeof(mbedtls_test_ca_crt_ec2),
#endif
    0
};
...
const size_t mbedtls_test_ca_crt_len  = sizeof( mbedtls_test_ca_crt_ec )+ sizeof(mbedtls_test_ca_crt_ec2);
