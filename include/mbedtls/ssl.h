...
/* TODO: Revisit error codes. Many of them are not applicable anymore to TLS 1.3 */
...
#define MBEDTLS_ERR_LAST 0x6795  /**< This definition points to the last error code to have a correct parsing in error.c */
...
/* These version definitions are used for 
 * controlling what is sent in the packet
 * as version number. As such, it untangles
 * the use of versions in the code and the 
 * version usage in the handshake messages. 
 *
 */
//#define TLS_DRAFT_VERSION_MAJOR 0x03
//#define TLS_DRAFT_VERSION_MINOR 0x04
...
#define KEY_EXCHANGE_MODE_ALL 252
#define KEY_EXCHANGE_MODE_PSK_ALL 255

 /* Modes for key derivation*/
//#define KEY_DERIVATION_MODE_BINDER_KEY 0
//#define KEY_DERIVATION_MODE_HANDSHAKE_TRAFFIC_SECRET 1
 ...
 * 
 * Currently only ECDSA algorithms are defined
 */
...
/* Handshake Messages
 */
#define MBEDTLS_SSL_HS_HELLO_REQUEST            0 // NOT used in TLS 1.3
#define MBEDTLS_SSL_HS_CLIENT_HELLO             1
#define MBEDTLS_SSL_HS_SERVER_HELLO             2
#define MBEDTLS_SSL_HS_HELLO_VERIFY_REQUEST     3 // NOT used in TLS 1.3
#define MBEDTLS_SSL_HS_NEW_SESSION_TICKET       4 // NEW IN TLS 1.3
#define MBEDTLS_SSL_HS_END_OF_EARLY_DATA        5 // NEW IN TLS 1.3
#define MBEDTLS_SSL_HS_HELLO_RETRY_REQUEST      6 // NEW IN TLS 1.3
#define MBEDTLS_SSL_HS_ENCRYPTED_EXTENSION      8 // NEW IN TLS 1.3
#define MBEDTLS_SSL_HS_CERTIFICATE             11
#define MBEDTLS_SSL_HS_SERVER_KEY_EXCHANGE     12 // NOT used in TLS 1.3
#define MBEDTLS_SSL_HS_CERTIFICATE_REQUEST     13
#define MBEDTLS_SSL_HS_SERVER_HELLO_DONE       14 // NOT used in TLS 1.3
#define MBEDTLS_SSL_HS_CERTIFICATE_VERIFY      15
#define MBEDTLS_SSL_HS_CLIENT_KEY_EXCHANGE     16 // NOT used in TLS 1.3
#define MBEDTLS_SSL_HS_FINISHED                20
#define MBEDTLS_SSL_HS_KEY_UPDATE              24 // NOT used in DTLS 1.3
...
/* In TLS 1.3 this is the supported_groups extensions */
#define MBEDTLS_TLS_EXT_SUPPORTED_GROUPS   10

#define MBEDTLS_TLS_EXT_SUPPORTED_POINT_FORMATS     11

/* In TLS 1.3 this is the signature_algorithms extension */
#define MBEDTLS_TLS_EXT_SIG_ALG                     13

#define MBEDTLS_TLS_EXT_ALPN                        16

#define MBEDTLS_TLS_EXT_ENCRYPT_THEN_MAC            22 /* 0x16 */
#define MBEDTLS_TLS_EXT_EXTENDED_MASTER_SECRET      23 /* 0x17 */

#define MBEDTLS_TLS_EXT_SESSION_TICKET              35

/* TLS 1.3 */
#define MBEDTLS_TLS_EXT_KEY_SHARES                 40 
...
#define MBEDTLS_TLS_EXT_TICKET_EARLY_DATA_INFO     46 
...
/*
 * States of the TLS 1.3 State Machine
 */
...
#endif
#if defined(MBEDTLS_MD_SHA256) && !defined(MBEDTLS_MD_SHA512)
	unsigned char master[32];   /*!< the master secret  */
#else 
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
	mbedtls_key_exchange_type_t key_exchange; /* Indication of the key exchange algorithm being negotiated*/
...
struct mbedtls_ssl_config
{
	...
	*/
    ...
    unsigned char *psk_identity;    /*!< pre-shared key identity            */
	...
	/* With this implementation of TLS 1.3 we only support version 1.3 
	 * and nothing else. Hence, min and max are actually the same. 
	 * In the future, if multiple versions are supported then this 
	 * structure needs to enhanced to support the full-blown TLS 1.3 style 
	 * of version negotation. 
	 */
...
struct mbedtls_ssl_context
{
	...
	// int prev_state;                  /*!< SSL handshake: previous state     */
     ...
     */
	 ...
	 /*!<  client_auth variable with    
	  *
	  * 0 = no certificate request received
	  * 1 = certificate request received
	  *
	  */
    int client_auth;                    
     ...
     */
#if defined(MBEDTLS_SSL_SERVER_NAME_INDICATION)
    char *hostname;             /*!< expected hostname for verification
    ...
    /*
     * Information for Cookie processing
     */
#if defined(MBEDTLS_SSL_COOKIE_C) && defined(MBEDTLS_SSL_SRV_C)
 ...
 * \param psk_identity_len  psk identity length
 *
 ...
 * \param psk      pointer to the pre-shared key
 * \param psk_len  pre-shared key length
 * \param psk_key_exchange_modes  allowed key exchange modes
 *
 * \return         0 if successful or MBEDTLS_ERR_SSL_ALLOC_FAILED
 */
...
void mbedtls_ssl_conf_sni( mbedtls_ssl_config *conf,
                  int (*f_sni)(void *, mbedtls_ssl_context *, const unsigned char *,
                               size_t),
                  void *p_sni );
#endif /* MBEDTLS_SSL_SERVER_NAME_INDICATION  and MBEDTLS_X509_CRT_PARSE_C */
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3) && defined(MBEDTLS_SSL_NEW_SESSION_TICKET)
/**
* \brief          Ticket handling API for a TLS client. 
*                 Initializes ticket structure. 
*
* \param ssl      SSL context
*/
...
/**
* \brief          Ticket handling API for a TLS client. 
*                 This function returns the ticket to the application
*                 (assuming that the server provided a ticket with the 
...
/**
* \brief          Ticket handling API for a TLS client.
*                 This function allows the application to configure a ticket to the TLS stack.
*                 It assumes that such a ticket has been obtained previously. 
*
* \param ssl      SSL context
* \param ticket   Ticket
*
...
/**
* \brief          Ticket handling API for a TLS client.
*                 Enables the use of the ticket support. 
*                 When a client receives a NewSessionTicket from the server 
*                 it will then re-use the ticket for resumption.  
*
* \param ssl      SSL context
*/
...
/**
* \brief          Ticket handling API for a TLS client.
*                 Disables the use of the ticket support.
*                 The client will not use tickets for resumption.
*
* \param ssl      SSL context
*/
