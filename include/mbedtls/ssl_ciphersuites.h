...
#define MBEDTLS_TLS_PSK_WITH_AES_128_GCM_SHA256          0xA8   /**< TLS 1.2 && TLS 1.3 */
#define MBEDTLS_TLS_PSK_WITH_AES_256_GCM_SHA384          0xA9   /**< TLS 1.2 && TLS 1.3 */
...
/* PSK suites based on 	[draft-ietf-tls-ecdhe-psk-aead-00] */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256       0xC0B1  /**< TLS 1.2 */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384       0xC0B2  /**< TLS 1.2 */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CCM_8_SHA256     0xC0B3  /**< TLS 1.2 */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256       0xC0B4  /**< TLS 1.2 */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CCM_SHA384       0xC0B5  /**< TLS 1.2 */
#define MBEDTLS_TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 0xC0B6  /**< TLS 1.2 */
#define MBEDTLS_TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256   0xC0B7  /**< TLS 1.2 */
...
// Ciphersuites defined for TLS 1.3
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
	mbedtls_cipher_type_t cipher; // The AEAD algorithm used for record protection
	mbedtls_md_type_t hash; // The hash algorithm used with HKDF
